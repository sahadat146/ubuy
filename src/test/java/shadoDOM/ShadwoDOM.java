...
public class ShadwoDOM {
	public static void main(String[] args) throws InterruptedException {
       ...
       // driver.findElement(By.id("username")).sendKeys("naveen");
        ...
        WebElement username =  (WebElement) jse.executeScript("return document.querySelector('amplify-authenticator > "
        		+ "amplify-sign-in').shadowRoot.querySelector('amplify-form-section > amplify-auth-fields').shadowRoot."
        		+ "querySelector('div > amplify-username-field').shadowRoot.querySelector('amplify-form-field').shadowRoot"
        		+ ".querySelector('input')");
